...
Therefore let's examine the other variables in the **mtcars** data set to see if including one or more ofthem could improve our model. **Figure 2** in the Appendix shows the plots and correlations between each of the variable pairs in the **mtcars** data set.
